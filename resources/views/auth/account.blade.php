...
<!-- form start -->
<form method="POST" action="{{ URL('my-profile/'.base64_encode($account->id)) }}" class="form-horizontal" id="form">
{{ csrf_field() }}
  <div class="row">
    <div class="col-md-8">
      <!-- Default box -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="{{ $account->username }}" disabled="true">
                  </div>
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="box-header with-border">
          ...
          <div class="box-body">
            <div class="box box-widget widget-user">
                ...
                <div class="widget-user-header bg-black" style="background: url({{ asset('upload/images/thumbnails/'.$account->getPegawai->picture) }}) center center; height: 230px;background-size: cover;">
                </div>
                <div class="widget-user-image" style="top: 180px;">
                  <img class="img-circle" src="{{ asset('upload/images/thumbnails/'.$account->getPegawai->picture) }}" alt="User Avatar">
                </div>
                  <div class="row" style="margin-top: 50px;">
                    <div class="col-sm-12 border-right">
                      <div class="description-block">
                        <h3 class="widget-user-username">{{ ucwords($account->getPegawai->name) }}</h3>
                        <h5 class="widget-user-desc">({{ ucwords($account->getPegawai->level) }})</h5>
                        <h5 class="description-header">{{ $account->getPegawai->phone }}</h5>
